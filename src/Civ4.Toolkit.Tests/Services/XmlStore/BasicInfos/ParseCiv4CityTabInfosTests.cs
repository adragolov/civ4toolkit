...
public class ParseCiv4CityTabInfosTests
{
    private ICiv4XmlStore<Civ4CityTabInfos> XmlStore = null!;
    ...
    public void Setup()
    {
        ...
        XmlStore = TestBootstrapper.ResolveDependency<ICiv4XmlStore<Civ4CityTabInfos>>();
    }
